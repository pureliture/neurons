...
public interface RetiredIndexBridgeGateway {
    RetiredIndexBridgeDocumentRef uploadDocument(String baseUrl, String apiKey, String datasetId, DocumentPayload payload);
    ...
    RetiredIndexBridgePressureSnapshot pressureSnapshot(String baseUrl, String apiKey, String datasetId);
    ...
    /**
     * Lists documents in the dataset whose name matches {@code keyword} (RetiredIndexBridge keyword search over
     ...
     */
    List<RetiredIndexBridgeDocumentSummary> listDocumentsByKeyword(String baseUrl, String apiKey, String datasetId, String keyword);
