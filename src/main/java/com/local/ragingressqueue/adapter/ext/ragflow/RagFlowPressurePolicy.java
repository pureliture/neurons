...
public record RagFlowPressurePolicy(
    int runningThrottleThreshold,
    int unstartThrottleThreshold,
    int runningClosedThreshold,
    int unstartClosedThreshold
) {
    public static final RagFlowPressurePolicy DEFAULT = new RagFlowPressurePolicy(20, 5, 100, 25);

    public TargetPressure evaluate(RagFlowPressureSnapshot snapshot) {
