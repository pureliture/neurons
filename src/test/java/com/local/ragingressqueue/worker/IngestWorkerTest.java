...
import com.local.ragingressqueue.queue.IngestMessage;
import com.local.ragingressqueue.target.DeliveryResult;
...
class IngestWorkerTest {
    ...
    private static final class FakeAdapter implements RagTargetAdapter {
        ...
        @Override
        public com.local.ragingressqueue.target.TargetStatusSnapshot getStatus(IngestJob job, String targetProfile) {
            return new com.local.ragingressqueue.target.TargetStatusSnapshot(
