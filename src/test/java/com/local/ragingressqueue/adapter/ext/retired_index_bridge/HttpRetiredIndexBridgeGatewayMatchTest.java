...
class HttpRetiredIndexBridgeGatewayMatchTest {
    ...
    void matchesWhenDocumentNameCarriesTheHashSuffixToken() throws Exception {
        ...
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(docs, "48daba68a6f6")).isTrue();
    }
    ...
    void rejectsSubstringHitThatIsNotADelimitedHashSuffix() {
        ...
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(docs, "48daba68a6f6")).isFalse();
    }
    ...
    void rejectsFragmentThatMatchesAnInnerDotTokenButNotTheFinalHashSuffix() {
        ...
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(docs, "abc")).isFalse();
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(docs, "def")).isTrue();
    }
    ...
    void returnsFalseForEmptyDocsOrBlankFragment() {
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(arrayOfNames(), "48daba68a6f6")).isFalse();
        assertThat(HttpRetiredIndexBridgeGateway.matchesContentHashFragment(arrayOfNames("chunk-48daba68a6f6.md"), "")).isFalse();
    }
