...
- PR #84부터 PR #95까지 `main`에 merge되었습니다. PR #97, PR #103, PR #105, PR #107, PR #109, PR #111, PR #113, PR #115, PR #119, PR #121, PR #122, PR #123, PR #124, PR #125, PR #126, PR #128, PR #142, PR #148, PR #150, PR #152, PR #162, PR #164, PR #166, PR #168, PR #170, PR #174, PR #176, PR #178, PR #180, and PR #182 are post-#95 source/docs/evidence-gate follow-ups merged to `main`.
...
- PR #168 and PR #170 make degraded P9 agent-context gaps actionable and consume future supplied live P9 agent-context packets through `live.agent_context.tool_hints`, `live.agent_context.product_sections`, `live.agent_context.startup_read_path`, and `live.evidence.provenance`. PR #176 adds a source-side P9 product-section gate for `current_authority` accepted-current authority, and PR #178 adds a startup/read-path gate requiring `current_authority` to be loaded in startup section counts. PR #182 extends that source-side gate so `style_preference` objects must carry `accepted_current` when present; reference-only style/profile objects remain disclosed gaps. Complete supplied live evidence can close the P9 source-side phase gaps, but current production desired state and live startup/read-path proof have not been shown for the post-#178 source; this is P9 evidence-consumption preparation, not deployed P9 production validation.
