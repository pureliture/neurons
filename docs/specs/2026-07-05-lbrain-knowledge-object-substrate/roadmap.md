...
- Production validation follow-up: `PASS_WITH_GAPS` overall; P1 MCP activation and P2 reference-corpus store gates are now `PASS` / `production_validated`, and P3 deployed source-to-candidate review-loop evidence is validated with a remaining projection-join gap. Local/safety gates, deployed/configured HTTP MCP smoke, post-#115 source/image identity, production deploy-button rollout, object authority schema ensure, source/review/readiness MCP tool exposure, production denied/no-mutation smokes, six-route `brain_objects_query` object-pack activation proof, bounded production Palantir reference-corpus ingest evidence, and deployed P2-corpus-to-candidate-review-loop evidence all passed. PR #95 was merged on 2026-07-07 with merge commit `32f4fec`; PR #97, PR #103, PR #105, PR #107, PR #109, PR #111, PR #113, PR #115, PR #119, PR #121, and PR #122 are source/docs/evidence-gate follow-ups. Jenkins build #22 produced MCP HTTP image tag `sha-9bdd780c2756` from source `9bdd780c2756`, neurons-ops PR #14 updated production desired state at merge commit `3145811`, and Jenkins production deploy button #11 synced `neurons-oci-production` to that desired state. This is P1/P2 gate proof plus partial P3 live proof, not product-wide production readiness: P3 live graph/Qdrant projection join, P4 bounded production authority execution, and P6/P7/P8/P9 runtime evidence remain gaps.
...
- PR #84부터 PR #95까지 `main`에 merge되었습니다. PR #97, PR #103, PR #105, PR #107, PR #109, PR #111, PR #113, PR #115, PR #119, PR #121, and PR #122는 post-#95 source/docs/evidence-gate follow-up으로 `main`에 merge되었습니다.
