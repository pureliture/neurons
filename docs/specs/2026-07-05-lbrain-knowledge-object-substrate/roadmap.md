...
- post-merge configured MCP read-only `deployment_runtime_truth` route smoke still returned `object_pack_route_not_implemented`, so source merge has not become deployed route proof
