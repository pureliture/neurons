...
- P3 Processing And Object Extraction Pipeline: in progress; local/test reference corpus extraction preview creates deterministic objects, edges, public-safe chunk preview, strategy comparison, evaluator evidence, and blocked-extraction gaps; repo document extraction, documentation cleanup, runtime truth, preference/style, work-unit, session-detail, PR/commit detail, and graph/search projection join previews now have local/test evaluator evidence.
...
- adjacent regression result: `139 passed, 1 warning`
- worker regression evidence: `cd worker && uv run pytest -q`
- worker regression result: `1526 passed, 9 skipped, 1 warning`

Remaining gaps:

- P3 is not complete; only the reference corpus extraction preview, repo-document extraction preview, documentation cleanup strategy comparison, runtime truth extraction preview, preference/style extraction preview, work-unit extraction preview, session-detail extraction preview, PR/commit detail extraction preview, and graph/search projection join preview slices are implemented
- evaluator coverage is limited to reference corpus, repo-document cleanup, documentation cleanup, PR merge/deploy truth, preference/style, temporal work recall, session detail extraction, PR commit/test provenance, and graph/search projection join golden query slices
...
| P3 Processing And Object Extraction Pipeline | `in_progress` | local/test reference corpus extraction preview, repo-document extraction preview, documentation cleanup strategy comparison, runtime truth extraction preview, preference/style extraction preview, work-unit extraction preview, session-detail extraction preview, PR/commit detail extraction preview, and graph/search projection join preview pass; live projection join and broader evaluator coverage remain gaps |
