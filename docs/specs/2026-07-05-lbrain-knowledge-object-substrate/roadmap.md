...
- runtime readiness bounded production authority execution now fails closed unless the rollback/supersession path includes `demote_prior_object_to_accepted_non_current_or_archive_only`
