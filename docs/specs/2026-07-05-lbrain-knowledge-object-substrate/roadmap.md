...
- latest configured route-smoke result: 2026-07-08 KST post-merge read-only calls returned public-safe `brain_objects_query.v1` envelopes with `object_pack_route_not_implemented` gaps for all six required routes
