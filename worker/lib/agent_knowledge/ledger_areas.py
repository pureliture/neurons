...
AREA_TABLES: dict[str, frozenset[str]] = {
    ...
    AREA_D: frozenset({
        ...
        "reference_corpus_document_sources",
        "reference_corpus_document_versions",
        "reference_corpus_document_snapshots",
        "reference_corpus_document_chunks",
        "reference_corpus_freshness_checks",
        "reference_corpus_extraction_runs",
