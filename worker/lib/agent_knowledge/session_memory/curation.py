...
from ..repository import LedgerMemoryCurationRepository
from .memory_card import build_memory_card


class CurationService:
    def __init__(self, ledger, *, repository=None):
        self.ledger = ledger
        self.repository = repository or LedgerMemoryCurationRepository(ledger)
    ...
    def approve(self, candidate_id: str, *, approved_by: str, supersedes: str = "") -> dict:
        ...
        return dict(self.repository.approve_candidate(candidate, card, approved_by=approved_by))
