    ...
    *,
    ...
    return OntologyEpisode.from_payload(
        ...
        payload={
            ...
            "source_hash": artifact.source_revision,
        ...
        observed_at=artifact.observed_at_start or artifact.created_at,
        reference_time=artifact.observed_at_end or artifact.observed_at_start or artifact.created_at,
